...
public class AcmeStandardThermoregulator implements AcmeThermoregulator,Runnable{
	...
	public AcmeStandardThermoregulator(AcmeThermometer thermometer, AcmeHeater heater) {
