...
import acme.AcmeEfficientThermoregulatorAdapter;
...
public class EfficientVentoWaterHeaterApp {
	...
	public static void main(String[] args) throws Exception {
		...
		final VentoThermoregulator ventoThermoregulator =new AcmeEfficientThermoregulatorAdapter(ventoThermometer, ventoHeater); // ACME efficient thermoregulator instance. 
